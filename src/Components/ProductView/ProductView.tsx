      ...
      <div className=" container mx-auto flex justify-around gap-4">
        ...
        <div className="flex flex-col w-[70vw] ">
          <div className="border bg-black rounded-md h-[30rem] flex justify-center relative">
            ...
            <img src={sampleImage} alt="" className="object-contain w-full" />
            <img
              src={olxLogo}
          ...
          <div className="bg-white border rounded border-gray-500 mt-4 p-2 flex flex-col gap-4">
            ...
            <p>
              ...
              voluptatibus voluptates voluptate, recusandae consectetur dolore
              vel amet, aperiam excepturi quasi, quia iure porro quod? Cumque at
              eligendi consectetur odio veniam.
            </p>
          </div>
        </div>
        {/* right side */}
        <div>
          <div className="border border-gray-500 rounded-md w-[30vw] p-4 flex flex-col gap-4 bg-white">
            ...
            <h2>
              ...
              minus fugit! Aliquid sed molestiae, in quam vitae repudiandae aut
              amet.
            </h2>
            <div className="flex justify-between text-sm">
              <p>DAG Colony, Port Blair, Andaman & Nicobar Islands</p>
              <p>12 June 2024</p>
            </div>
          </div>
          <div className="border border-gray-500 rounded-md w-[30vw] p-4 flex flex-col gap-4 bg-white mt-4">
            <div className="flex justify-between items-center">
              <h2 className="text-xl font-bold">Name of the seller</h2>
